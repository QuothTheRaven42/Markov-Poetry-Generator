...
- **Keys**: #-word tuples indexing into the n-gram dictionary
- **N-grams**: #-word sequences extracted from the input corpus
- **Line generation**: Chains # n-grams with #-word overlaps
